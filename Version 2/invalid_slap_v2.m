function [new_pseudo,new_slapper,new_slapper_size] = invalid_slap_v2(pseudo_center,slapper_deck)
%INVALID_SLAP_V2: The last card from the invalid slapper's deck is removed
